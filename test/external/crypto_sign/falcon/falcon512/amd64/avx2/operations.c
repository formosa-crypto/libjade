 ...
 */
#if JADE_SIGN_FALCON_FALCON512_AMD64_AVX2_PUBLICKEYBYTES == 897
#define LOGN   9
#elif JADE_SIGN_FALCON_FALCON512_AMD64_AVX2_PUBLICKEYBYTES == 1793
#define LOGN   10
#else
 ...
 */
#if JADE_SIGN_FALCON_FALCON512_AMD64_AVX2_SECRETKEYBYTES > 10000
#define KG_EXPAND   1
#else
#define KG_EXPAND   0
#endif
...
jade_sign_falcon_falcon512_amd64_avx2_keypair(unsigned char *pk, unsigned char *sk)
{
    ...
    sk[0] = 0x50 + LOGN;
    u = 1;
    v = Zf(trim_i8_encode)(sk + u, JADE_SIGN_FALCON_FALCON512_AMD64_AVX2_SECRETKEYBYTES - u,
    ...
    u += v;
    if (u != JADE_SIGN_FALCON_FALCON512_AMD64_AVX2_SECRETKEYBYTES) {
        return -1;
    }
#endif
     ...
     */
    pk[0] = 0x00 + LOGN;
    v = Zf(modq_encode)(pk + 1, JADE_SIGN_FALCON_FALCON512_AMD64_AVX2_PUBLICKEYBYTES - 1, h, LOGN);
    if (v != JADE_SIGN_FALCON_FALCON512_AMD64_AVX2_PUBLICKEYBYTES - 1) {
        return -1;
    }
    ...
    const unsigned char *sk)
{
    ...
    v = Zf(trim_i8_decode)(f, LOGN, Zf(max_fg_bits)[LOGN],
        sk + u, JADE_SIGN_FALCON_FALCON512_AMD64_AVX2_SECRETKEYBYTES - u);
    if (v == 0) {
        return -1;
    }
    u += v;
     ...
     */
    esig[0] = 0x20 + LOGN;
    sig_len = Zf(comp_encode)(esig + 1, JADE_SIGN_FALCON_FALCON512_AMD64_AVX2_BYTES - 1, sig, LOGN);
    if (sig_len == 0) {
        return -1;
    }
    sig_len ++;
...
extern
int
jade_sign_falcon_falcon512_amd64_avx2_open(unsigned char *m, size_t *mlen, const unsigned char *sm,
...
{
    return jade_sign_falcon_falcon512_amd64_avx2_open(m, mlen, sm, smlen, pk);
}
