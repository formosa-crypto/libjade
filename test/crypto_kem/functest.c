...
/*
int jade_kem_keypair(uint8_t *pk, uint8_t *sk);

int jade_kem_enc(uint8_t *ct, uint8_t *ss, const uint8_t *pk);

int jade_kem_dec(uint8_t *ss, const uint8_t *ct, const uint8_t *sk);
*/
