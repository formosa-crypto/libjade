...
module M = {
  proc __init_1_ref (nonce:W64.t, key:W32.t Array8.t) : W32.t Array16.t = {
    var aux: int;
  ...
  proc __salsa20_xor_1_ref (output:W64.t, plain:W64.t, len:W64.t,
  ...
  proc __salsa20_1_ref (output:W64.t, len:W64.t, nonce:W64.t,
  ...
  proc __xsalsa20_xor_ref (output:W64.t, plain:W64.t, len:W64.t, nonce:W64.t,
                           key:W64.t) : unit = {
  ...
  proc __xsalsa20_ref (output:W64.t, len:W64.t, nonce:W64.t, key:W64.t) : unit = {
  ...
  proc jade_stream_xsalsa20_amd64_ref_xor (output:W64.t, plain:W64.t,
  ...
  proc jade_stream_xsalsa20_amd64_ref (output:W64.t, len:W64.t, nonce:W64.t,
                                       key:W64.t) : W64.t = {
