...
module M = {
  ...
  proc __init_v_1_avx (nonce:W64.t, key:W32.t Array8.t) : W128.t Array16.t = {
    var aux: int;
  ...
  proc __salsa20_xor_v_1_avx (output:W64.t, plain:W64.t, len:W64.t,
  ...
  proc __salsa20_v_1_avx (output:W64.t, len:W64.t, nonce:W64.t,
  ...
  proc __salsa20_xor_1_avx (output:W64.t, plain:W64.t, len:W64.t,
                            nonce:W64.t, key:W32.t Array8.t) : unit = {
    
    
    
    __salsa20_xor_v_1_avx (output, plain, len, nonce, key);
    return ();
  }
  
  proc __salsa20_1_avx (output:W64.t, len:W64.t, nonce:W64.t,
                        key:W32.t Array8.t) : unit = {
    
    
    
    __salsa20_v_1_avx (output, len, nonce, key);
    return ();
  }
  
  proc __xsalsa20_xor_avx (output:W64.t, plain:W64.t, len:W64.t, nonce:W64.t,
                           key:W64.t) : unit = {
    ...
    __salsa20_xor_1_avx (output, plain, len, nonce, subkey);
    return ();
  }
  
  proc __xsalsa20_avx (output:W64.t, len:W64.t, nonce:W64.t, key:W64.t) : unit = {
  ...
  proc jade_stream_xsalsa20_amd64_avx_xor (output:W64.t, plain:W64.t,
  ...
  proc jade_stream_xsalsa20_amd64_avx (output:W64.t, len:W64.t, nonce:W64.t,
                                       key:W64.t) : W64.t = {
