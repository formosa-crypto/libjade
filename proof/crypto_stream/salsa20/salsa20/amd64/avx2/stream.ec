...
module M = {
  ...
  proc __salsa20_xor_v_avx2 (output:W64.t, plain:W64.t, len:W64.t,
  ...
  proc __salsa20_v_avx2 (output:W64.t, len:W64.t, nonce:W64.t, key:W64.t) : unit = {
  ...
  proc __salsa20_xor_avx2 (output:W64.t, plain:W64.t, len:W64.t, nonce:W64.t,
                           key:W64.t) : unit = {
    
    
    
    __salsa20_xor_v_avx2 (output, plain, len, nonce, key);
    return ();
  }
  
  proc __salsa20_avx2 (output:W64.t, len:W64.t, nonce:W64.t, key:W64.t) : unit = {
    
    
    
    __salsa20_v_avx2 (output, len, nonce, key);
    return ();
  }
  
  proc jade_stream_salsa20_salsa20_amd64_avx2_xor (output:W64.t, plain:W64.t,
  ...
  proc jade_stream_salsa20_salsa20_amd64_avx2 (output:W64.t, len:W64.t,
