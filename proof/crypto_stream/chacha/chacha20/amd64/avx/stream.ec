...
module M = {
  ...
  proc __increment_counter02_h_avx (st:W128.t Array4.t) : W128.t Array4.t = {
    ...
    st.[3] <- (st.[3] \vadd64u128 CHACHA_P02_H_AVX);
    return (st);
  }
  ...
  proc __increment_counter01_h_avx (st:W128.t Array4.t) : W128.t Array4.t = {
    ...
    st.[3] <- (st.[3] \vadd64u128 CHACHA_P01_H_AVX);
    return (st);
  }
  ...
  proc __increment_counter_v_avx (st:W128.t Array16.t) : W128.t Array16.t = {
    ...
    a <- VPUNPCKL_4u32 x y;
    b <- VPUNPCKH_4u32 x y;
    a <- (a \vadd64u128 CHACHA_P44_V_AVX);
    b <- (b \vadd64u128 CHACHA_P44_V_AVX);
    x <- VPUNPCKL_4u32 a b;
    y <- VPUNPCKH_4u32 a b;
    a <- VPUNPCKL_4u32 x y;
    b <- VPUNPCKH_4u32 x y;
  ...
  proc jade_stream_chacha_chacha20_amd64_avx_xor (output:W64.t, plain:W64.t,
  ...
  proc jade_stream_chacha_chacha20_amd64_avx (output:W64.t, len:W64.t,
