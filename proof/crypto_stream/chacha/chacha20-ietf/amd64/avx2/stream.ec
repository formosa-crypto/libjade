...
abbrev CHACHA_P88888888_H_AVX2 = W256.of_int 215679573387421932252121579908212843056389298378842373074615151886344.


abbrev CHACHA_P00040004_H_AVX2 = W256.of_int 1361129467683753853853498429727072845828.


abbrev CHACHA_P00020002_H_AVX2 = W256.of_int 680564733841876926926749214863536422914.


abbrev CHACHA_P00010000_H_AVX2 = W256.of_int 340282366920938463463374607431768211456.
...
module M = {
  proc __init_h_avx2 (nonce:W64.t, key:W64.t) : W256.t Array4.t = {
    ...
    st.[3] <- (st.[3] \vadd32u256 CHACHA_P00010000_H_AVX2);
    return (st);
  }
  ...
  proc __increment_counter0404_h_avx2 (st:W256.t Array4.t) : W256.t Array4.t = {
    ...
    st.[3] <- (st.[3] \vadd32u256 CHACHA_P00040004_H_AVX2);
    return (st);
  }
  ...
  proc __increment_counter0202_h_avx2 (st:W256.t Array4.t) : W256.t Array4.t = {
    ...
    st.[3] <- (st.[3] \vadd32u256 CHACHA_P00020002_H_AVX2);
    return (st);
  }
  ...
  proc jade_stream_chacha_chacha20_ietf_amd64_avx2_xor (output:W64.t,
                                                        plain:W64.t,
                                                        len:W64.t,
                                                        nonce:W64.t,
                                                        key:W64.t) : 
  ...
  proc jade_stream_chacha_chacha20_ietf_amd64_avx2 (output:W64.t, len:W64.t,
