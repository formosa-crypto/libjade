...
module M = {
  ...
  proc __shake128_ref (out:W64.t, outlen:W64.t, in_0:W64.t, inlen:W64.t) : unit = {
    
    var trail_byte:W8.t;
    var rate:W64.t;
    
    trail_byte <- (W8.of_int 31);
    rate <- (W64.of_int (1344 %/ 8));
    __keccak1600_ref (out, outlen, in_0, inlen, trail_byte, rate);
    return ();
  }
  
  proc jade_xof_shake128_amd64_ref (out:W64.t, outlen:W64.t, in_0:W64.t,
                                    inlen:W64.t) : W64.t = {
    ...
    __shake128_ref (out, outlen, in_0, inlen);
