...
module M = {
  ...
  proc __sha3_256_ref (out:W64.t, in_0:W64.t, inlen:W64.t) : unit = {
    
    var outlen:W64.t;
    var trail_byte:W8.t;
    var rate:W64.t;
    
    outlen <- (W64.of_int (256 %/ 8));
  ...
  proc jade_hash_sha3_256_amd64_ref (out:W64.t, in_0:W64.t, inlen:W64.t) : 
  W64.t = {
