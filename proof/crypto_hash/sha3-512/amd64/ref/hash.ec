...
module M = {
  ...
  proc __sha3_512_ref (out:W64.t, in_0:W64.t, inlen:W64.t) : unit = {
    
    var outlen:W64.t;
    var trail_byte:W8.t;
    var rate:W64.t;
    
    outlen <- (W64.of_int (512 %/ 8));
    trail_byte <- (W8.of_int 6);
    rate <- (W64.of_int (576 %/ 8));
    _keccak1600_ref (out, outlen, in_0, inlen, trail_byte, rate);
    return ();
  }
  
  proc jade_hash_sha3_512_amd64_ref (out:W64.t, in_0:W64.t, inlen:W64.t) : 
  W64.t = {
