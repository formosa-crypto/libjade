...
#define JADE_STREAM_SALSA20_SALSA2012_AMD64_REF_ARCH    "amd64"
#define JADE_STREAM_SALSA20_SALSA2012_AMD64_REF_IMPL    "ref"

#include <stdint.h>

int jade_stream_salsa20_salsa2012_amd64_ref_xor(
 uint8_t *ciphertext,
 uint8_t *plaintext,
 uint64_t length,
...
int jade_stream_salsa20_salsa2012_amd64_ref(
 uint8_t *stream,
 uint64_t length,
 uint8_t *nonce, /*NONCEBYTES*/
 uint8_t *key /*KEYBYTES*/
