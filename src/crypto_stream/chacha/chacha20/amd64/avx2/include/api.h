...
#define JADE_STREAM_CHACHA_CHACHA20_AMD64_AVX2_ARCH    "amd64"
#define JADE_STREAM_CHACHA_CHACHA20_AMD64_AVX2_IMPL    "avx2"

#include <stdint.h>

int jade_stream_chacha_chacha20_amd64_avx2_xor(
 uint8_t *ciphertext,
 uint8_t *plaintext,
 uint64_t length,
