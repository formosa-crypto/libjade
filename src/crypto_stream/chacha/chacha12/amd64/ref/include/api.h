...
#define JADE_STREAM_CHACHA_CHACHA12_AMD64_REF_ARCH    "amd64"
#define JADE_STREAM_CHACHA_CHACHA12_AMD64_REF_IMPL    "ref"

#include <stdint.h>

int jade_stream_chacha_chacha12_amd64_ref_xor(
 uint8_t *output,
 const uint8_t *input,
