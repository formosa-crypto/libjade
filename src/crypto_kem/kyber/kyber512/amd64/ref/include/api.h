...
#define JADE_KEM_KYBER_KYBER512_AMD64_REF_SECRETKEYBYTES  2400
#define JADE_KEM_KYBER_KYBER512_AMD64_REF_PUBLICKEYBYTES  1184
#define JADE_KEM_KYBER_KYBER512_AMD64_REF_CIPHERTEXTBYTES 1088
