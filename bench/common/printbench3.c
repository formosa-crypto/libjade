#ifndef PRINTBENCH3_H
#define PRINTBENCH3_H

#include <inttypes.h>
#include <stdlib.h>
#include <stdio.h>

void pb_alloc_3(uint64_t** results[OP][LOOPS], size_t _x, size_t _y)
{
  size_t o, l, x;
  for (o=0; o<OP; o++)
  { for (l=0; l<LOOPS; l++)
...
void pb_free_3(uint64_t** results[OP][LOOPS], size_t _x)
{
  size_t o, l, x;
  for (o=0; o<OP; o++)
  { for (l=0; l<LOOPS; l++)
